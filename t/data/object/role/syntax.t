...
subtest 'test the clearer function' => sub {
    is_deeply [Data::Object::Role::Syntax::clearer()], [
        clearer => 1,
    ];
...
subtest 'test the coerce function' => sub {
    is_deeply [Data::Object::Role::Syntax::coerce()], [
        coerce => 1,
    ];
};
...
subtest 'test the is function' => sub {
    is_deeply [Data::Object::Role::Syntax::is(1..9)], [
        1..9,
    ];
};
...
subtest 'test the isa function' => sub {
    my $code = sub { 1 };
    is_deeply [Data::Object::Role::Syntax::isa($code)], [
        isa => $code,
    ];
};

subtest 'test the lazy function' => sub {
    is_deeply [Data::Object::Role::Syntax::lazy()], [
        lazy => 1,
    ];
};
...
subtest 'test the predicate function' => sub {
    is_deeply [Data::Object::Role::Syntax::predicate()], [
        predicate => 1,
    ];
...
subtest 'test the reader function' => sub {
    is_deeply [Data::Object::Role::Syntax::reader()], [
        reader => 1,
    ];
...
subtest 'test the required function' => sub {
    is_deeply [Data::Object::Role::Syntax::required()], [
        required => 1,
    ];
};

subtest 'test the ro function' => sub {
    is_deeply [Data::Object::Role::Syntax::ro()], [
        is => 'ro',
    ];
};

subtest 'test the rw function' => sub {
    is_deeply [Data::Object::Role::Syntax::rw()], [
        is => 'rw',
    ];
};

subtest 'test the trigger function' => sub {
    is_deeply [Data::Object::Role::Syntax::trigger()], [
        trigger => 1,
    ];
...
subtest 'test the weak_ref function' => sub {
    is_deeply [Data::Object::Role::Syntax::weak_ref()], [
        weak_ref => 1,
    ];
};

subtest 'test the writer function' => sub {
    is_deeply [Data::Object::Role::Syntax::writer()], [
        writer => 1,
    ];
